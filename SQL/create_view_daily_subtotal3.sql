CREATE VIEW `view_daily_subtotal3` AS
with `ranked_reservations` as (
  select 
    `pre_daily_subtotal3`.`sche_id` AS `sche_id`,
    `pre_daily_subtotal3`.`status` AS `status`,
    `pre_daily_subtotal3`.`status` AS `status_name`,
    `pre_daily_subtotal3`.`reservation_id` AS `reservation_id`,
    `pre_daily_subtotal3`.`reservation_name` AS `reservation_name`,
    `pre_daily_subtotal3`.`reservation_date` AS `reservation_date`,
    `pre_daily_subtotal3`.`branch` AS `branch`,
    `pre_daily_subtotal3`.`count` AS `count`,
    `pre_daily_subtotal3`.`additional_sales` AS `additional_sales`,
    `pre_daily_subtotal3`.`date` AS `date`,
    `pre_daily_subtotal3`.`room_id` AS `room_id`,
    `pre_daily_subtotal3`.`room_name` AS `room_name`,
    `pre_daily_subtotal3`.`start` AS `start`,
    `pre_daily_subtotal3`.`end` AS `end`,
    `pre_daily_subtotal3`.`due_date` AS `due_date`,
    `pre_daily_subtotal3`.`cancel_date` AS `cancel_date`,
    `pre_daily_subtotal3`.`d_created` AS `d_created`,
    `pre_daily_subtotal3`.`d_mod` AS `d_mod`,
    `pre_daily_subtotal3`.`d_decided` AS `d_decided`,
    `pre_daily_subtotal3`.`d_tentative` AS `d_tentative`,
    `pre_daily_subtotal3`.`d_edited` AS `d_edited`,
    `pre_daily_subtotal3`.`people` AS `people`,
    `pre_daily_subtotal3`.`subtotal` AS `subtotal`,
    `pre_daily_subtotal3`.`gross` AS `gross`,
    `pre_daily_subtotal3`.`net` AS `net`,
    `pre_daily_subtotal3`.`service_fee` AS `service_fee`,
    `pre_daily_subtotal3`.`tax` AS `tax`,
    `pre_daily_subtotal3`.`discount` AS `discount`,
    `pre_daily_subtotal3`.`ex_ts` AS `ex_ts`,
    `pre_daily_subtotal3`.`purpose_id` AS `purpose_id`,
    `pre_daily_subtotal3`.`purpose_name` AS `purpose_name`,
    `pre_daily_subtotal3`.`purpose_short` AS `purpose_short`,
    `pre_daily_subtotal3`.`banquet_category_id` AS `banquet_category_id`,
    `pre_daily_subtotal3`.`banquet_category_name` AS `banquet_category_name`,
    `pre_daily_subtotal3`.`sales_dept_id` AS `sales_dept_id`,
    `pre_daily_subtotal3`.`sales_dept_name2` AS `sales_dept_name`,
    `pre_daily_subtotal3`.`sales_dept_short` AS `sales_dept_short`,
    `pre_daily_subtotal3`.`sales_category_id` AS `sales_category_id`,
    `pre_daily_subtotal3`.`sales_category_name` AS `sales_category_name`,
    `pre_daily_subtotal3`.`pic` AS `pic`,
    `pre_daily_subtotal3`.`pic_id` AS `pic_id`,
    `pre_daily_subtotal3`.`agent_id` AS `agent_id`,
    `pre_daily_subtotal3`.`agent_name` AS `agent_name`,
    `pre_daily_subtotal3`.`agent_short` AS `agent_short`,
    `pre_daily_subtotal3`.`agent_name2` AS `agent_name2`,
    `pre_daily_subtotal3`.`reserver` AS `reserver`,
    row_number() OVER (
      PARTITION BY 
        `pre_daily_subtotal3`.`date`,
        `pre_daily_subtotal3`.`room_id` 
      ORDER BY `pre_daily_subtotal3`.`gross` desc 
    )  AS `rn` 
  from `pre_daily_subtotal3`
) 
select 
